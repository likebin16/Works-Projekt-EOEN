...
insert into `hk_admin`(`id`,`uid`,`depa`,`name`,`pawd`,`times`,`flags`,`state`) values('1','9001','9001','杨震南','e10adc3949ba59abbe56e057f20f883e','2017-02-28 08:57:42','1000,2000,3000,4000,5000','1');
...
insert into `hk_admin`(`id`,`uid`,`depa`,`name`,`pawd`,`times`,`flags`,`state`) values('3','9003','9000','陆祥林','a7abf29b68607c9b4c2d2574475e5ce1','2017-02-27 17:30:00','1000','1');
...
insert into `hk_assets`(`id`,`stoid`,`stonm`,`stosl`,`stokc`,`stock`,`stobf`,`stoad`,`stote`) values('4','HK201702271460','鼠标键盘','100','99','1','1','测试','1');
...
insert into `hk_asslist`(`id`,`zid`,`name`,`depa`,`user`,`time`,`note`,`state`) values('4','JJS201702232428','HK201702227189','1001','1002','2017-02-23 11:07:31','213213','10');
insert into `hk_asslist`(`id`,`zid`,`name`,`depa`,`user`,`time`,`note`,`state`) values('5','JJS201702275763','HK201702276873','9001','9003','2017-02-27 11:23:05','123','5');
insert into `hk_asslist`(`id`,`zid`,`name`,`depa`,`user`,`time`,`note`,`state`) values('6','JJS201702276160','HK201702271460','9001','9001','2017-02-27 12:24:35','测试','10');
insert into `hk_asslist`(`id`,`zid`,`name`,`depa`,`user`,`time`,`note`,`state`) values('7','JJS201702275128','HK201702276873','9001','5001','2017-02-27 15:27:40','123<br />
','0');
...
insert into `hk_sqlbk`(`id`,`name`,`time`,`data`,`user`) values('24','HK-20170227734.sql','2017-02-27 19:34:21','67.2KB','杨震南');
